...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void CreateNewAccount()
    {
        ...
        else
        {
            ...
            loadingBar.setMessage("Please wait while we are creating an new account for You...");
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task)
                        {
                            if (task.isSuccessful())
                            {
                                ...
                                Toast.makeText(RegisterActivity.this, "Acount Created Successfuly!", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }
                            else
                            {
                                String messsage = task.getException().toString();
                                Toast.makeText(RegisterActivity.this, "Error: " + messsage, Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }
                        }
                    });
    ...
    {
        CreateAccounButton = (Button) findViewById(R.id.register_button);
